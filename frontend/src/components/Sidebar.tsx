  ...
  return (
    <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
      <nav className="nav-section">
        ...
        <NavItem
          to="/video"
          icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2" ry="2"/></svg>}
          label={t('nav.video')}
          badge="hot"
          collapsed={collapsed}
        />
      ...
      <div className="sidebar-footer">
        <NavLink to="/referral" className="sidebar-footer-item referral-link">
          ...
          {!collapsed && t('sidebar.affiliateProgram')}
        </NavLink>
        <button className="sidebar-footer-item" onClick={() => setCollapsed(!collapsed)}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            {collapsed ? (
              <>
        ...
        <div className="sidebar-social">
          <a href="https://discord.gg/lumiere-ai" target="_blank" rel="noopener noreferrer" title="Discord">
          ...
          <a href="https://twitter.com/lumiere-ai" target="_blank" rel="noopener noreferrer" title="X (Twitter)">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a>
          <a href="https://instagram.com/lumiere-ai" target="_blank" rel="noopener noreferrer" title="Instagram">
